...
function makeColors(t: Theme): ThemeColors {
  ...
  return {
    ...
    textSecondary:      d ? "rgba(255,255,255,.65)"   : "rgba(4,9,26,.65)",
    textMuted:          d ? "rgba(255,255,255,.45)"   : "rgba(4,9,26,.45)",
    textFaint:          d ? "rgba(255,255,255,.25)"   : "rgba(4,9,26,.22)",
    ...
    border:             d ? "rgba(255,255,255,.08)"   : "rgba(38,69,200,.14)",
    borderHover:        d ? "rgba(255,255,255,.22)"   : "rgba(38,69,200,.4)",
    navBg:              d ? "rgba(4,9,26,0.72)"       : "rgba(255,255,255,0.84)",
    navBorder:          d ? "rgba(255,255,255,0.1)"   : "rgba(38,69,200,0.15)",
    navText:            d ? "rgba(255,255,255,.65)"   : "rgba(4,9,26,.65)",
    ...
    footerBorder:       d ? "rgba(255,255,255,.06)"   : "rgba(38,69,200,.1)",
    inputBg:            d ? "rgba(255,255,255,.04)"   : "rgba(255,255,255,0.9)",
    inputBorder:        d ? "rgba(255,255,255,.12)"   : "rgba(38,69,200,.22)",
