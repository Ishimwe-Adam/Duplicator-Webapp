    ...
    >
      <div className="quotation-shell mx-auto max-w-[860px]">
        ...
        <section className="print-paper rounded-[18px] border border-[#cad7f5] bg-white p-3 shadow-[0_30px_80px_rgba(0,0,0,.22)]">
          <div className="quotation-paper mx-auto text-black">
            <PaperPreview
      ...
      <style>{`
        ...
        @media print {
          ...
          .quotation-shell { max-width: none !important; }
          .print-paper {
          ...
          .quotation-paper { max-height: none !important; }
        }
      `}</style>
    </DashboardLayout>
  );
  ...
  return (
    <article className="bg-white px-5 py-4 text-[11px] leading-5 text-black">
      ...
      <section className="mt-2 rounded-[4px] border border-black p-3 text-[10px]">
        ...
        {remarks.trim() && <p className="mt-1 font-semibold">Remarks: {remarks.trim()}</p>}
      </section>
