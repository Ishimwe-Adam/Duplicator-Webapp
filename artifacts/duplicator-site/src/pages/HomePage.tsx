...
function ServiceCard({ num, title, desc, items, icon, inverted = false }: {
  ...
  return (
    <div
      ...
      style={{
        background: isDark ? "var(--navy)" : "#fff",
        padding: "40px 36px",
        position: "relative",
        overflow: "hidden",
        cursor: "default",
...
export default function HomePage() {
  ...
  return (
    <div style={{ background: "var(--off-white)" }}>
      ...
      {/* HERO */}
      <section id="home" style={{ position: "relative", minHeight: "100vh", background: "var(--ink)", display: "flex", alignItems: "center", overflow: "hidden" }}>
      ...
      {/* SERVICES */}
      <section id="services" style={{ background: "var(--off-white)", padding: "100px 0", position: "relative" }}>
        <div style={{ maxWidth: 1320, margin: "0 auto", padding: "0 24px" }}>
          ...
          <RevealDiv delay={0.1} style={{ marginTop: 64 }}>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 2, border: "2px solid var(--ink)", borderRadius: 12, overflow: "hidden" }}>
              {services.map(s => (
      ...
      {/* STATS */}
      <div style={{ background: "var(--blue)", padding: "80px 0", position: "relative", overflow: "hidden" }}>
        <div style={{ maxWidth: 1320, margin: "0 auto", padding: "0 24px" }}>
      ...
      {/* PRODUCTS */}
      <section id="products" style={{ background: "#fff", padding: "100px 0" }}>
        <div style={{ maxWidth: 1320, margin: "0 auto", padding: "0 24px" }}>
      ...
      {/* GET QUOTE */}
      <section id="quote" style={{ background: "var(--navy)", padding: "100px 0", position: "relative", overflow: "hidden" }}>
      ...
      {/* CONTACT */}
      <section id="contact" style={{ background: "var(--off-white)", padding: "100px 0" }}>
        <div style={{ maxWidth: 1320, margin: "0 auto", padding: "0 24px" }}>
...
function ContactCard({ icon, label, value, href, green }: { icon: string; label: string; value: string; href: string | null; green: boolean; }) {
  ...
  const style: React.CSSProperties = {
    background: "#fff", border: `1.5px solid ${hovered ? "var(--blue)" : "var(--light-grey)"}`,
    borderRadius: 10, padding: "20px 24px", display: "flex", alignItems: "center", gap: 16,
    textDecoration: "none", transition: "all .25s",
    boxShadow: hovered ? "0 8px 24px rgba(38,69,200,.1)" : "none"
  };
  return href ? (
