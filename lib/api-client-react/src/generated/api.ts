 ...
 */
export const listOrders = async ( options?: RequestInit): Promise<OrderListResponse> => {
...
export const updateOrderStatus = async (id: number,
    updateOrderStatusInput: UpdateOrderStatusInput, options?: RequestInit): Promise<OrderDetail> => {
...
export const getListInvoicesQueryOptions = <TData = Awaited<ReturnType<typeof listInvoices>>, TError = ErrorType<ErrorResponse>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listInvoices>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
 ...
 */
export const createInvoice = async (createInvoiceInput: CreateInvoiceInput, options?: RequestInit): Promise<InvoiceDetail> => {
 ...
 */
export const createTask = async (createTaskInput: CreateTaskInput, options?: RequestInit): Promise<TaskSummary> => {

  return customFetch<TaskSummary>(getCreateTaskUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const updateTask = async (id: number,
    updateTaskInput: UpdateTaskInput, options?: RequestInit): Promise<TaskSummary> => {

  return customFetch<TaskSummary>(getUpdateTaskUrl(id),
  {
    ...options,
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const recordPayment = async (id: number,
    recordPaymentInput: RecordPaymentInput, options?: RequestInit): Promise<InvoiceDetail> => {
...
export const getRecordPaymentMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof recordPayment>>, TError,{id: number;data: BodyType<RecordPaymentInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof recordPayment>>, TError,{id: number;data: BodyType<RecordPaymentInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof recordPayment>>, {id: number;data: BodyType<RecordPaymentInput>}> = (props) => {
          const {id,data} = props ?? {};
...
export const updateInvoiceStatus = async (id: number,
    updateInvoiceStatusInput: UpdateInvoiceStatusInput, options?: RequestInit): Promise<InvoiceDetail> => {
...
export const getUpdateInvoiceStatusMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateInvoiceStatus>>, TError,{id: number;data: BodyType<UpdateInvoiceStatusInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateInvoiceStatus>>, TError,{id: number;data: BodyType<UpdateInvoiceStatusInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateInvoiceStatus>>, {id: number;data: BodyType<UpdateInvoiceStatusInput>}> = (props) => {
          const {id,data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdateInvoiceStatusMutationBody = BodyType<UpdateInvoiceStatusInput>
    export type UpdateInvoiceStatusMutationError = ErrorType<ErrorResponse>

    /**
 * @summary Update an invoice's status (admin only)
 */
export const useUpdateInvoiceStatus = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateInvoiceStatus>>, TError,{id: number;data: BodyType<UpdateInvoiceStatusInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
